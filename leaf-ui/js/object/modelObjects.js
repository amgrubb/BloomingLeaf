class Model {
   ...
   /**
    * 
    * Removes all leftover information from analysis 
    * and resets to the inital states
    */
   removeAnalysis(){
...
/** 
 * 6/9/21 These are the functions we are migrating towards for the backbone refactor 
 * currently named with Test because we cannot phase out the originals just yet 
 * */
...
class LinkTest {
     ...
     *   TODO ex. -1, 0,...,n
     */
    constructor(linkType, absoluteValue) {
        this.linkID = this.createID();
        this.linkType = linkType;
        this.postType = null;
        this.linkSrcID = null;
