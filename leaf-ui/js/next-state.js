 ...
 { // LOCAL GLOBAL VARIABLES
    ...
    function init(){
        if (false){
            ...
            console.log("New Model");
            console.log(JSON.stringify(window.opener.graph.toJSON()));
            var newGraphString = '{"type":"goalmodel.Graph","maxAbsTime":100,"absTimePtsArr":[],"constraints":[],"cells":[{"type":"basic.Goal","size":{"width":100,"height":60},"intention":{"cid":"c52","attributes":{"nodeName":"untitled","nodeActorID":null,"nodeType":null,"evolvingFunction":{"cid":"c60","attributes":{"type":"NT","functionSegList":[],"hasRepeat":false,"repStart":null,"repStop":null,"repCount":null,"repAbsTime":null},"_changing":false,"_previousAttributes":{},"changed":{},"_pending":false},"userEvaluationList":[{"cid":"c53","attributes":{"assignedEvidencePair":"(no value)","absTime":0},"_changing":false,"_previousAttributes":{},"changed":{},"_pending":false}]},"_changing":false,"_previousAttributes":{"nodeName":"untitled","nodeActorID":null,"nodeType":null,"evolvingFunction":null,"userEvaluationList":[{"cid":"c53","attributes":{"assignedEvidencePair":"(no value)","absTime":0},"_changing":false,"_previousAttributes":{},"changed":{},"_pending":false}]},"changed":{"evolvingFunction":{"cid":"c60","attributes":{"type":"NT","functionSegList":[],"hasRepeat":false,"repStart":null,"repStop":null,"repCount":null,"repAbsTime":null},"_changing":false,"_previousAttributes":{},"changed":{},"_pending":false}},"_pending":false},"position":{"x":470,"y":240},"angle":0,"id":"fb6735e7-7ddd-41b2-ba09-010bf7620c80","z":1,"attrs":{".satvalue":{"text":"(⊥, ⊥)"},"text":{"fill":"black","stroke":"none"}}}]}';
            analysis.graph.fromJSON(JSON.parse(JSON.stringify(window.opener.graph.toJSON())));
            //analysis.graph.fromJSON(JSON.parse(newGraphString));
        }    
    }
