...
var IntentionBBM = Backbone.Model.extend({
    ...
    addAbsConst: function(funcType) {
        if (funcType == 'RC' || funcType == 'CR' || funcType == 'MP' ||
            ...
            model.constraints.push(new ConstraintBBM({type: 'A', srcID: this.nodeID, srcRefTP: 'A', destID: null, destRefTP: null}));
        }
    }, 
    ...
    addUserDefinedSeg: function(funcType, satValue){
        ...
        model.constraints.push(new ConstraintBBM({type: 'A', srcID: this.nodeID, srcRefTP: start, destID: null, destRefTP: null}));
